...
## Overview
`CircularChart` is a ready-to-use building block. Think of it like a LEGO piece: give it some props, place it inside another widget, and FletBox creates the browser element for you.
...
## When to use
Use `CircularChart` when you need this kind of interface element. Start with the smallest example, then add one prop at a time. You can copy the example, change the text or color, and see the result immediately.
...
| `size` | `Any` | - | Component size or preset. |
| `colors` | `Any` | [] | Property used by the CircularChart component. |
| `showLabels` | `Any` | false | Property used by the CircularChart component. |
| `children` | `Any` | - | Property used by the CircularChart component. |
| `id` | `Any` | - | Property used by the CircularChart component. |
| `className` | `Any` | - | Property used by the CircularChart component. |
| `ref` | `Any` | - | Property used by the CircularChart component. |
| `onClick` | `Any` | - | Property used by the CircularChart component. |
...
```javascript
import { CircularChart, Text } from "flet-box";

const example = CircularChart({
  data: [],
