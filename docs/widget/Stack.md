...
## Overview
`Stack` is a ready-to-use building block. Think of it like a LEGO piece: give it some props, place it inside another widget, and FletBox creates the browser element for you.
...
## When to use
Use `Stack` when you need this kind of interface element. Start with the smallest example, then add one prop at a time. You can copy the example, change the text or color, and see the result immediately.
...
| --- | --- | --- | --- |
| `width` | `Size` | - | Property used by the Stack component. |
| `height` | `Size` | - | Property used by the Stack component. |
...
| `borderRadius` | `number \| string` | - | Property used by the Stack component. |
| `elevation` | `number` | - | Property used by the Stack component. |
| `shadow` | `string` | - | Property used by the Stack component. |
| `opacity` | `number` | - | Property used by the Stack component. |
| `visible` | `boolean` | false | Property used by the Stack component. |
...
| `onClick` | `(widget: Widget) => void` | - | Property used by the Stack component. |
| `id` | `string` | - | Property used by the Stack component. |
| `className` | `string` | - | Property used by the Stack component. |
| `ref` | `(widget: Widget) => void` | - | Property used by the Stack component. |
| `disableTransform` | `boolean` | - | Property used by the Stack component. |
| `children` | `Widget[]` | - | Property used by the Stack component. |
| `position` | `'relative' \| 'absolute'` | - | Property used by the Stack component. |
| `alignment` | `'top-left' \| 'top-center' \| 'top-right' \| 'center-left' \| 'center' \| 'center-right' \| 'bottom-left' \| 'bottom-center' \| 'bottom-right'` | - | Property used by the Stack component. |
...
Stack({
    ...
    children: [
        ...
        FloatingActionButton({ icon: "add", position: "bottomRight", margin: 16 })
    ]
})
```
