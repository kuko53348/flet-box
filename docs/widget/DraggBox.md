...
## Overview
`DraggBox` is a ready-to-use building block. Think of it like a LEGO piece: give it some props, place it inside another widget, and FletBox creates the browser element for you.
...
## When to use
Use `DraggBox` when you need this kind of interface element. Start with the smallest example, then add one prop at a time. You can copy the example, change the text or color, and see the result immediately.
...
| --- | --- | --- | --- |
| `width` | `Size` | - | Property used by the DraggBox component. |
| `height` | `Size` | - | Property used by the DraggBox component. |
...
| `borderRadius` | `number \| string` | - | Property used by the DraggBox component. |
| `elevation` | `number` | - | Property used by the DraggBox component. |
| `shadow` | `string` | - | Property used by the DraggBox component. |
| `opacity` | `number` | - | Property used by the DraggBox component. |
| `visible` | `boolean` | false | Property used by the DraggBox component. |
...
| `onClick` | `(widget: Widget) => void` | - | Property used by the DraggBox component. |
| `id` | `string` | - | Property used by the DraggBox component. |
| `className` | `string` | - | Property used by the DraggBox component. |
| `ref` | `(widget: Widget) => void` | - | Property used by the DraggBox component. |
| `disableTransform` | `boolean` | - | Property used by the DraggBox component. |
| `child` | `Widget` | - | Property used by the DraggBox component. |
| `data` | `any` | [] | Collection of items used to render content. |
| `group` | `string` | - | Property used by the DraggBox component. |
| `onDragStart` | `(event: DragEvent, data: any) => void` | - | Property used by the DraggBox component. |
| `onDragEnd` | `(event: DragEvent, data: any) => void` | - | Property used by the DraggBox component. |
| `dragImage` | `HTMLElement` | - | Property used by the DraggBox component. |
| `cloneOnDrag` | `boolean` | - | Property used by the DraggBox component. |
| `dragOverlayColor` | `Color` | - | Property used by the DraggBox component. |
| `dragBorderColor` | `Color` | - | Property used by the DraggBox component. |
