...
## Overview
`Switch` is a ready-to-use building block. Think of it like a LEGO piece: give it some props, place it inside another widget, and FletBox creates the browser element for you.
...
## When to use
Use `Switch` when you need this kind of interface element. Start with the smallest example, then add one prop at a time. You can copy the example, change the text or color, and see the result immediately.
...
| --- | --- | --- | --- |
| `width` | `Size` | - | Property used by the Switch component. |
| `height` | `Size` | - | Property used by the Switch component. |
...
| `borderRadius` | `number \| string` | - | Property used by the Switch component. |
| `elevation` | `number` | - | Property used by the Switch component. |
| `shadow` | `string` | - | Property used by the Switch component. |
| `opacity` | `number` | - | Property used by the Switch component. |
| `visible` | `boolean` | false | Property used by the Switch component. |
...
| `onClick` | `(widget: Widget) => void` | - | Property used by the Switch component. |
| `id` | `string` | - | Property used by the Switch component. |
| `className` | `string` | - | Property used by the Switch component. |
| `ref` | `(widget: Widget) => void` | - | Property used by the Switch component. |
| `disableTransform` | `boolean` | - | Property used by the Switch component. |
| `value` | `boolean` | - | Current value controlled by the widget. |
| `onToggle` | `(value: boolean) => void` | - | Property used by the Switch component. |
| `activeColor` | `Color` | - | Property used by the Switch component. |
...
```javascript
import { Switch, Text } from "flet-box";
...
```javascript
Switch({ value: isEnabled, onToggle: setIsEnabled, label: "Notifications" })
```
