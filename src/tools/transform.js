...
export const transform = (options = {}) => {
    ...
    if (options.translateX) parts.push(`translateX(${typeof options.translateX === 'number' ? options.translateX + 'px' : options.translateX})`);
    if (options.translateY) parts.push(`translateY(${typeof options.translateY === 'number' ? options.translateY + 'px' : options.translateY})`);
    if (options.translateZ) parts.push(`translateZ(${typeof options.translateZ === 'number' ? options.translateZ + 'px' : options.translateZ})`);
    ...
    // Perspective
    if (options.perspective) parts.push(`perspective(${typeof options.perspective === 'number' ? options.perspective + 'px' : options.perspective})`);
