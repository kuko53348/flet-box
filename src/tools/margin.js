...
export const margin = (value) => {
    ...
    if (typeof value === 'object') {
        const top = value.top !== undefined ? value.top : (value.vertical !== undefined ? value.vertical : (value.all !== undefined ? value.all : 0));
        const right = value.right !== undefined ? value.right : (value.horizontal !== undefined ? value.horizontal : (value.all !== undefined ? value.all : 0));
        const bottom = value.bottom !== undefined ? value.bottom : (value.vertical !== undefined ? value.vertical : (value.all !== undefined ? value.all : 0));
        const left = value.left !== undefined ? value.left : (value.horizontal !== undefined ? value.horizontal : (value.all !== undefined ? value.all : 0));
