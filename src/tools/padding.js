...
/**
 * Generates a CSS `padding` shorthand string from a number, a plain CSS string,
 ...
 * padding(20)                                        // "20px"
 * padding({ all: 20 })                               // "20px"
 * padding({ horizontal: 20, vertical: 10 })          // "10px 20px"
 * padding({ top: 10, right: 20, bottom: 10, left: 20 }) // "10px 20px"
 * padding({ left: 20, right: 20 })                   // "0px 20px"
 * padding({ top: 10, bottom: 10 })                   // "10px 0px"
 */
