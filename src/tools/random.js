...
const firstNames = [
    ...
    'Elena', 'Miguel', 'Carmen', 'José', 'Isabel', 'Francisco', 'Marta', 
    'David', 'Lucía', 'Javier', 'Paula', 'Daniel'
];

const lastNames = [
    'García', 'Pérez', 'López', 'Martínez', 'Sánchez', 'Rodríguez', 
    'Fernández', 'González', 'Díaz', 'Moreno', 'Jiménez', 'Ruiz', 
    'Hernández', 'Álvarez', 'Romero', 'Navarro', 'Torres', 'Domínguez'
];

const domains = [
    'gmail.com', 'yahoo.com', 'hotmail.com', 'outlook.com', 
    'icloud.com', 'protonmail.com', 'example.com', 'mail.com'
];
...
export const random = {
     ...
     * @returns {string}
     */
    string: (length = 8) => Math.random().toString(36).substring(2, 2 + length),
