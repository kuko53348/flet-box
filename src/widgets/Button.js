...
export const Button = (props) => {
  ...
  // Add top icon (if any)
  const topIconEl = makeIcon(
    iconTop || (icon && iconPosition === "top" ? icon : null),
  );
  ...
  // Add left icon
  const leftIconEl = makeIcon(
    iconLeft || (icon && iconPosition === "left" ? icon : null),
  );
  ...
  // Add bottom icon
  const bottomIconEl = makeIcon(
    iconBottom || (icon && iconPosition === "bottom" ? icon : null),
  );
