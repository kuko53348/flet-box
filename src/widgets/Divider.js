...
export const Divider = (props = {}) => {
    ...
    const finalThickness = typeof thickness === 'number' ? `${thickness}px` : thickness;
    ...
    if (typeof margin === 'number') {
        ...
        const top = margin.top !== undefined ? (typeof margin.top === 'number' ? `${margin.top}px` : margin.top) : '0';
        const right = margin.right !== undefined ? (typeof margin.right === 'number' ? `${margin.right}px` : margin.right) : '0';
        const bottom = margin.bottom !== undefined ? (typeof margin.bottom === 'number' ? `${margin.bottom}px` : margin.bottom) : '0';
        const left = margin.left !== undefined ? (typeof margin.left === 'number' ? `${margin.left}px` : margin.left) : '0';
