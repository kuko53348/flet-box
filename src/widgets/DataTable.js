...
export const DataTable = (props) => {
    ...
    table.style.border = bordered ? `${borderWidth}px solid ${borderColor}` : 'none';
    ...
    for (const col of columns) {
        ...
        th.style.fontSize = typeof headerFontSize === 'number' ? `${headerFontSize}px` : headerFontSize;
    ...
    rows.forEach((row, index) => {
        ...
        if (hoverable) {
            ...
            tr.addEventListener('mouseleave', () => {
                tr.style.backgroundColor = striped && index % 2 === 1 
                    ? stripedRowBgColor 
                    : rowBgColor;
            });
        }
        ...
        for (const col of columns) {
            ...
            td.style.fontSize = typeof rowFontSize === 'number' ? `${rowFontSize}px` : rowFontSize;
            ...
            if (typeof col !== 'string' && col.format && typeof col.format === 'function') {
